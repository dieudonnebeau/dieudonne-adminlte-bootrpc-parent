 ...
 */
@Controller
@RequestMapping("/app/blogVote")
public class AppBlogVoteController extends SuperController{  

	@Autowired private IAppBlogVoteService appBlogVoteService;
...
//    } 
    ...
    public  String add(Model model){
		return "app/blogVote/add";
    } 
    
    
	@RequiresPermissions("addBlog")
    @Log("Création du nouveau blog vote ")
    @RequestMapping("/doAdd")  
	@ResponseBody
    public  Rest doAdd(AppBlogVote blogVote){
		appBlogVoteService.save(blogVote);
		return Rest.ok();
    }  
   
	@RequiresPermissions("deleteBlog")
    @Log("Supprimer le blog vote")
    @RequestMapping("/delete")  
    @ResponseBody
    public  Rest delete(String id){
		appBlogVoteService.deleteByID(id);
    	return Rest.ok();
    }  
    ...
    public  String edit(@PathVariable String id,Model model){
    	AppBlogVote blogVote = appBlogVoteService.queryByID(id);
    	
    	model.addAttribute("blogVote",blogVote);
    	return "app/blog/edit";
    } 

	@RequiresPermissions("editBlog")
    @Log("Modifier le blog vote")
    @RequestMapping("/doEdit")  
	@ResponseBody
    public  Rest doEdit(AppBlogVote blogVote,Model model){
		appBlogVoteService.updateByID(blogVote);
    	return Rest.ok();
    } 
